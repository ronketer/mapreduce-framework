...
* **Advanced Synchronization:** Secured shared data integrity using **mutexes**, **atomic counters**, and a custom reusable **Barrier** to coordinate phases across threads. 
* **Deterministic Concurrency:** Engineered a centralized shuffle phase (managed by TID 0) to ensure deterministic intermediate data organization before reduction. 
...
The framework utilizes a reusable **Barrier** to synchronize threads between distinct execution stages:
